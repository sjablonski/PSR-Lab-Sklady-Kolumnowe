...
exports.tableVisitColumns = "id text, date text, type text, car frozen <car>, employees list<frozen <employee>>, client frozen <client>, description text, PRIMARY KEY (id)";
